...
class _ProfilScreenState extends State<ProfilScreen> {
  ...
  void _populateFields(Map<String, dynamic> user) {
    ...
    _namaBelakangController.text   = parts.length > 1 ? parts.sublist(1).join(' ') : '';
  ...
  Future<void> _onSaveChanges() async {
    ...
    final namaLengkap  = namaBelakang.isEmpty ? namaDepan : '$namaDepan $namaBelakang';
        ...
        title: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.logout_rounded, color: Color(0xFFC0392B), size: 20),
            ),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: const [
                    BoxShadow(color: _blackOpacity25, blurRadius: 12, offset: Offset(0, 4)),
                  ],
                ),
                child: Center(
                  child: Text(
                    ...
                    style: const TextStyle(
                      ...
                      fontWeight: FontWeight.bold, color: Color(0xFF1A2B45),
                    ),
                  ),
                ),
              ),
              ...
              Text(
                ...
                style: const TextStyle(
                  fontFamily: 'Georgia', fontSize: 21,
              ...
              Text(
                email,
                style: const TextStyle(fontSize: 13, color: _whiteOpacity55, letterSpacing: 0.2),
              ),
              ...
              if (lokasi.isNotEmpty) ...[
                ...
                Row(
                  ...
                  children: [
                    const Icon(Icons.location_on, size: 14, color: _whiteOpacity40),
                    const SizedBox(width: 4),
                    Text(
                      lokasi,
                      style: const TextStyle(fontSize: 12.5, color: _whiteOpacity40),
                    ),
                  ],
                ),
              ],
            ...
            return Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: const [
                    BoxShadow(color: _blackOpacity06, blurRadius: 10, offset: Offset(0, 4)),
                  ],
                ),
                child: Column(
                  children: [
                    Text(
                      ...
                      style: const TextStyle(
                        ...
                        fontWeight: FontWeight.bold, color: navyDark, height: 1.1,
                      ),
                    ),
                    const SizedBox(height: 4),
                    Text(
  ...
  Widget _buildAccountInfoForm() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFFE8E2D8), width: 1.2),
        boxShadow: const [
          BoxShadow(color: _blackOpacity06, blurRadius: 10, offset: Offset(0, 3)),
        ],
      ),
      child: Column(
        ...
        children: [
          const Text(
            ...
            style: TextStyle(
              ...
              letterSpacing: 1.3, color: Color(0xFF8A9BB0),
            ),
          ),
          ...
          Row(
            children: [
              Expanded(child: _buildFormField(label: 'NAMA DEPAN',    controller: _namaDepanController)),
              const SizedBox(width: 12),
              Expanded(child: _buildFormField(label: 'NAMA BELAKANG', controller: _namaBelakangController)),
            ],
          ),
          const SizedBox(height: 18),

          _buildFormField(label: 'EMAIL',            controller: _emailController,          keyboardType: TextInputType.emailAddress),
          const SizedBox(height: 18),

          _buildFormField(label: 'NO. TELEPON',      controller: _teleponController,        keyboardType: TextInputType.phone),
          const SizedBox(height: 18),

          _buildFormField(label: 'NAMA PETERNAKAN',  controller: _namaPeternakanController),
          const SizedBox(height: 18),
          ...
          SizedBox(
            ...
            child: OutlinedButton(
              ...
              child: _isSaving
                  ...
                  : const Text(
                      'Simpan Perubahan',
                      style: TextStyle(fontSize: 14.5, fontWeight: FontWeight.w600, letterSpacing: 0.3),
                    ),
            ),
          ),
        ],
      ...
      children: [
        Text(
          ...
          style: const TextStyle(
            ...
            letterSpacing: 1.0, color: Color(0xFF7A8A9D),
          ),
        ),
        ...
        Container(
          ...
          child: TextField(
            ...
            style: const TextStyle(fontSize: 14, color: navyDark, fontWeight: FontWeight.w400),
