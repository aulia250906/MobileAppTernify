            ...
            SafeArea(
              child: AnimatedBuilder(
                ...
                builder: (context, child) {
                  return SizedBox(
                    width: double
                        .infinity, // INI PERBAIKAN PRESISI (AGAR CENTER HORIZONTAL)
                    child: Column(
        ...
        children: [
          Row(
            ...
            children: List.generate(3, (index) {
              final brightness =
                  (math.sin(
                        (_mainController.value * math.pi * 2) + (index * 1.0),
                      ) +
                      1) /
                  2;
              return Container(
  ...
  List<Widget> _buildDecorativeCircles() {
    return [
      Positioned(
        top: -80,
        right: -60,
        child: _buildCircle(220, const Color(0x0AFFFFFF)),
      ),
      Positioned(
        bottom: -100,
        left: -80,
        child: _buildCircle(280, const Color(0x0D4A90E2)),
      ),
      Positioned(
        top: 60,
        left: 40,
        child: _buildSolidCircle(12, const Color(0x26CFBFA5)),
      ),
      Positioned(
        top: 300,
        right: 30,
        child: _buildSolidCircle(8, const Color(0x334A90E2)),
      ),
      Positioned(
        bottom: 120,
        right: 50,
        child: _buildSolidCircle(16, const Color(0x0FFFFFFF)),
      ),
    ];
  }
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: RadialGradient(
          colors: [
            color,
            color.withAlpha((color.a * 0.02).round()),
            Colors.transparent,
          ],
        ),
      ),
